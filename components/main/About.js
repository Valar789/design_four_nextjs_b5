    ...
    <section id="about" className="about">
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          <div className="col-lg-5 align-items-stretch video-box imageAbout" >
            <Link href="https://www.youtube.com/watch?v=jDDaplaOz7Q" ><a  className="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a></Link>
          </div>
